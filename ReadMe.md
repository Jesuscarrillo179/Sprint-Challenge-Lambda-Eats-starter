...
useRouteMatch is used for to match the current url in a funtion.

2. How would you explain form validation to someone who has never programmed before?
Form validation is not being able to submit a form because of a missing input, you need to fill out the required inputs to submit.

3. In 1-2 sentences, define end to end testing.
end to end testing is testing out one or different applications to ensure they all work as intended. 
